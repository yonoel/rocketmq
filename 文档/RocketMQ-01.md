...
```bash
#set rocketmq
ROCKETMQ_HOME=/opt/rocketmq/rocketmq-all-4.7.1-bin-release
...
```sh
vi /opt/rocketmq/rocketmq-all-4.7.1-bin-release/conf/2m-2s-sync/broker-a.properties
```
...
brokerId=0
#nameServer地址，分号分割
namesrvAddr=192.168.1.225:9876;192.168.1.204:9876
...
```sh
vi /opt/rocketmq/rocketmq-all-4.7.1-bin-release/conf/2m-2s-sync/broker-b-s.properties
```
...
```sh
vi /opt/rocketmq/rocketmq-all-4.7.1-bin-release/conf/2m-2s-sync/broker-b.properties
```
...
```sh
vi  /opt/rocketmq/rocketmq-all-4.7.1-bin-release/conf/2m-2s-sync/broker-a-s.properties
```
...
```sh
vi  /opt/rocketmq/rocketmq-all-4.7.1-bin-release/bin/runbroker.sh
```
...
```sh
vim  /opt/rocketmq/rocketmq-all-4.7.1-bin-release/bin/runserver.sh
```
...
```bash
cd  /opt/rocketmq/rocketmq-all-4.7.1-bin-release/bin
nohup sh mqnamesrv &
```
...
```bash
cd  /opt/rocketmq/rocketmq-all-4.7.1-bin-release/bin
nohup sh mqbroker -c /opt/rocketmq/rocketmq-all-4.7.1-bin-release/conf/2m-2s-sync/broker-a.properties &
```
...
```sh
cd  /opt/rocketmq/rocketmq-all-4.7.1-bin-release/bin
nohup sh mqbroker -c /opt/rocketmq/rocketmq-all-4.7.1-bin-release/conf/2m-2s-sync/broker-b-s.properties &
```
...
```sh
cd  /opt/rocketmq/rocketmq-all-4.7.1-bin-release/bin
nohup sh mqbroker -c /opt/rocketmq/rocketmq-all-4.7.1-bin-release/conf/2m-2s-sync/broker-b.properties &
```
...
nohup sh mqbroker -c /opt/rocketmq/rocketmq-all-4.7.1-bin-release/conf/2m-2s-sync/broker-a-s.properties &
```
...
```sh
cd /opt/rocketmq_console/rocketmq-externals/rocketmq-console/src/main/resources
